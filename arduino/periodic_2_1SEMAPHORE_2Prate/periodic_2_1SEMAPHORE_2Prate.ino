...
void loop() { 
  ...
  */
  th1=periodic_thread_create(&periodic_task1, NULL, NULL, 200, 30, 0, 1000000, 1000000, 5000000, &error_handler_task1); 
  sem1= thread_semaphore_create(1); //Semaphore initialized
  th2=periodic_thread_create(&periodic_task2, NULL, NULL, 200, 30, 100000, 1000000, 1000000, 5000000, &error_handler_task2); 
