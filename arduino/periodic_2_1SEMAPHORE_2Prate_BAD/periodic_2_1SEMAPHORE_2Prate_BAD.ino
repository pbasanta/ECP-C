...
//  thread_semaphore_P(sem1); //P operation
  ...
  thread_semaphore_P(sem1); //P operation
  aux_t=handler;
  thread_semaphore_V(sem1); //P operation
}
...
void periodic_task2() 
{
  ...
  thread_semaphore_P(sem1); //V operation
  handler++;
...
void loop() { 
  ...
  */
  ...
  th2=periodic_thread_create(&periodic_task2, NULL, NULL, 200, 30, 100000, 1000000, 10000000, 5000000, &error_handler_task2); 
