...
void loop() { 
  ...
  */
  ...
  THREAD* th1=sporadic_thread_create(&sporadic_task1, NULL, NULL, 200, 30, 10000, 1000000, 1000000, 500000, (uint8_t) (SIMPLERTFRAMEWORK_OVER_EXCEPT_POLICY|SIMPLERTFRAMEWORK_SAVE_POLICY), 1, &error_handler_task1); 
  signaler=th1; 
  THREAD* th2=periodic_thread_create(&periodic_task2, NULL, NULL, 200, 40, 0, 1000000, 1000000, 500000, &error_handler_task2); 
