...
void error_handler_task3(int erno)
{
  Serial.print("[T3] Error------\t \n  erno:"); 
  Serial.println(erno);   
  while(1){
  }
}
...
void loop() { 
  ...
  Serial.print("Simple example\n  -1x(100 ms) periodic led \n - 1x(1 second)reader\n - 1x(sporadic) producer. \nIntroduce data\n\n");  
  delay(1000); 
  /*
    Thread creation.
    ...
    error function
  */
  THREAD* th1=sporadic_thread_create(&sporadic_task1, NULL,NULL, 200, 30, 10000, 1000000, 1000000, 500000, SIMPLERTFRAMEWORK_SAVE_POLICY, 0, &error_handler_task1); 
  signaler=th1; 
  THREAD* th2=periodic_thread_create(&periodic_task2, NULL, NULL, 200, 20, 0, 1000000, 1000000, 500000,&error_handler_task2); 
  THREAD* th3=periodic_thread_create(&periodic_task3, NULL, NULL, 200, 20, 0, 100000, 100000, 50000,&error_handler_task3); 
