...
void periodic_task2() {
  if (Serial.available() > 0) 
  {
    ...
    thread_signal(signaler);
    thread_signal(signaler); // It should not signal anything
  }
...
//  THREAD* th1=aperiodic_thread_create(&aperiodic_task1, NULL, NULL, 200, 20, 0, 1000000, 500000, SIMPLERTFRAMEWORK_OVER_SAVE_POLICY, 2, &error_handler_task1); 
  THREAD* th1=aperiodic_thread_create(&aperiodic_task1, NULL, NULL, 200, 20, 0, 1000000, 500000, SIMPLERTFRAMEWORK_OVER_IGNORE_POLICY, 1, NULL); 
  signaler=th1; 
